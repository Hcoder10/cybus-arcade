...
2. **Sanitize Luau patterns.** Strip game-specific identifiers (rename `BossOfDeath` to `Boss`, drop magic numbers when generic substitutes work). Keep the SHAPE that's reusable.
